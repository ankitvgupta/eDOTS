...
public class NewVisitLoadTask extends AsyncTask<String,String,Visit> {
    ...
    protected Visit doInBackground(String... params) {
        ...
        try
        {
            ...
            String CodigoGroupoVisita = ic.getProperty("CodigoGroupoVisita").toString();
            String NombreGroupoVisita = ic.getProperty("NombreGroupoVisita").toString();
            ...
            v = new Visit(params[1],params[2],CodigoGroupoVisita,NombreGroupoVisita,CodigoVisita,DescripcionVisita,
