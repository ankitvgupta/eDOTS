...
public class NewPatientDataActivity extends Activity {
    ...
    public void addToDatabase(String name, String father, String mother, String docType, String nationalID, String birthDate, String phoneNumber, String sex, ArrayList<String> visitDays) {
...
//            addToDatabase(name, fatherName, motherName, "2", nationalID, birthDate, phone_number, sex, visitDays, treatment_startDate, treatment_endDate);
